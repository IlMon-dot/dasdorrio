/* ДАННЫЕ САЙТА — правится только этот файл.
   ...
   сцена      — картинка фона под палитрой (photo/bg/), квадрат 1400 px, ≤ 120 КБ;
                поверх неё ложится тон «фон» палитры, внизу — сплошной, чтобы текст читался.
                Нет строки — сцена просто одноцветная
