/* ДАННЫЕ САЙТА — правится только этот файл.
   ...
   площадки   — чистые идентификаторы для скрипта цен (без меток, по ним скрипт берёт цены раз в день):
                wb — артикул WB (nmID, цифры), ozon — SKU Ozon (цифры из адреса ozon.ru/product/<SKU>/),
                shop — адрес товара на dasdorrio.ru без «?» и «#». Нет идентификатора — цены у кнопки не будет */
